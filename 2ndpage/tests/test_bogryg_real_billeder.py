...
præcist i den fysiske rille mellem siderne -- se
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("273098_001496", 1325, 40),  # andenside/verso
        ("273098_001497", 335, 40),  # tredjeside/recto
        ("273099_001360", 1380, 40),  # andenside/verso
        ("273099_001361", 419, 40),  # tredjeside/recto
    ],
)
