# Maaling af 20260830_171607_beskaaret

| Bogholderi | |
|---|---|
| Model | `gemini-3.1-pro-preview` |
| Promptversion | `textpage_uaendret/beskrevet` |
| Dato | 2026-08-30T17:16:07 |
| Sider målt | 11 |
...
Målt på **90,01 % af facits tegn** (89,15 % af linjerne). De udeladte er de sværeste.

| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 8,91 % | 25,10 % | 534 | 5991 |
| `uden_versaler` | 8,26 % | 22,33 % | 495 | 5991 |
| `uden_diakritika` | 8,90 % | 25,00 % | 533 | 5991 |
| `uden_tegnsaetning` | 8,07 % | 21,35 % | 460 | 5699 |
| `arbejdstal` | 7,39 % | 18,27 % | 421 | 5699 |
| `lempeligst` | 7,37 % | 18,17 % | 420 | 5699 |

Af de 59 linjer med mindst ét `[?]` kunne forankringen redde **55** ind i målingen ved at måle de kendte stumper omkring det ulæselige sted. Grundreglen er ellers, at hele linjen går ud (beslutning 38), så uden det trin ville dækningen have været væsentligt lavere.
...
Den strenge måling ser **75,02 % af facits tegn** (resten ligger på linjer med mindst ét `[?]`) og fik fat i 94,73 % af dem.

| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 8,73 % | 25,19 % | 412 | 4719 |
| `uden_versaler` | 8,07 % | 22,03 % | 381 | 4719 |
| `uden_diakritika` | 8,71 % | 25,06 % | 411 | 4719 |
| `uden_tegnsaetning` | 7,89 % | 21,57 % | 354 | 4486 |
| `arbejdstal` | 7,20 % | 18,27 % | 323 | 4486 |
| `lempeligst` | 7,18 % | 18,15 % | 322 | 4486 |

**Sammenlign de to.** Hovedtallet er 7,39 %, den strenge er 7,20 % (`arbejdstal`) — en forskel på 0,19 %.
...
| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 9,44 % | 25,78 % | 547 | 5796 |
| `uden_versaler` | 8,73 % | 23,05 % | 506 | 5796 |
| `uden_diakritika` | 9,42 % | 25,68 % | 546 | 5796 |
| `uden_tegnsaetning` | 8,50 % | 21,30 % | 467 | 5492 |
| `arbejdstal` | 7,76 % | 18,25 % | 426 | 5492 |
| `lempeligst` | 7,74 % | 18,16 % | 425 | 5492 |

Linjer der er nøjagtig rigtige (`arbejdstal`): 119 af 230 = 51,74 %
...
| Signal | Værdi |
|---|---:|
| Modeltekst uden modstykke i facit | 531 tegn = 9,74 % af modellens tekst |
| Tekst skrevet dér hvor facit siger `[?]` | 119 tegn fordelt på 20 steder |
...
| Mål | Værdi |
|---|---:|
| Facit-linjer der ligger inden for én af modellens linjer | 224 af 230 |
| Facit-linjer der får deres egen modellinje | 229 af 230 |
...
|---|---:|---:|---:|---:|
| `273108_001555` | 13,58 % | 89,17 % | 18/18 | 60 |
| `273103_001462` | 12,18 % | 91,65 % | 25/27 | 62 |
| `273104_001639` | 11,13 % | 77,81 % | 19/22 | 76 |
| `273102_001064` | 10,08 % | 96,61 % | 23/24 | 14 |
| `273099_001445` | 7,24 % | 93,73 % | 20/24 | 54 |
| `273107_001864` | 6,22 % | 94,22 % | 26/29 | 49 |
...
| `273104_001639` | 77,81 % | 11,13 % | 19/22 | 76 |
| `273108_001555` | 89,17 % | 13,58 % | 18/18 | 60 |
| `273103_001462` | 91,65 % | 12,18 % | 25/27 | 62 |
| `273098_001503` | 91,74 % | 2,93 % | 15/17 | 26 |
| `273099_001445` | 93,73 % | 7,24 % | 20/24 | 54 |
| `273107_001864` | 94,22 % | 6,22 % | 26/29 | 49 |
| `273100_001306` | 94,31 % | 2,62 % | 23/26 | 46 |
| `273109_000081` | 94,72 % | 4,69 % | 20/20 | 33 |
| `273102_001064` | 96,61 % | 10,08 % | 23/24 | 14 |
