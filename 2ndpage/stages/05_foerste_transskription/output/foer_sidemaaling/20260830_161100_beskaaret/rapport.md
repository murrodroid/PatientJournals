# Maaling af 20260830_161100_beskaaret

| Bogholderi | |
|---|---|
| Model | `gemini-3.1-pro-preview` |
| Promptversion | `layoutviden/usikkerhed` |
| Dato | 2026-08-30T16:11:00 |
| Sider målt | 12 |
...
Målt på **88,25 % af facits tegn** (87,86 % af linjerne). De udeladte er de sværeste.

| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 7,77 % | 24,35 % | 502 | 6463 |
| `uden_versaler` | 7,09 % | 21,56 % | 458 | 6463 |
| `uden_diakritika` | 7,75 % | 24,26 % | 501 | 6463 |
| `uden_tegnsaetning` | 6,93 % | 20,45 % | 426 | 6149 |
| `arbejdstal` | 6,21 % | 17,37 % | 382 | 6149 |
| `lempeligst` | 6,20 % | 17,27 % | 381 | 6149 |
...
Den strenge måling ser **76,94 % af facits tegn** (resten ligger på linjer med mindst ét `[?]`) og fik fat i 92,67 % af dem.

| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 7,70 % | 24,85 % | 401 | 5207 |
| `uden_versaler` | 7,07 % | 21,82 % | 368 | 5207 |
| `uden_diakritika` | 7,68 % | 24,74 % | 400 | 5207 |
| `uden_tegnsaetning` | 6,85 % | 20,94 % | 339 | 4951 |
| `arbejdstal` | 6,18 % | 17,78 % | 306 | 4951 |
| `lempeligst` | 6,16 % | 17,66 % | 305 | 4951 |

**Sammenlign de to.** Hovedtallet er 6,21 %, den strenge er 6,18 % (`arbejdstal`) — en forskel på 0,03 %.
...
| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 8,23 % | 24,93 % | 515 | 6259 |
| `uden_versaler` | 7,51 % | 22,18 % | 470 | 6259 |
| `uden_diakritika` | 8,21 % | 24,84 % | 514 | 6259 |
| `uden_tegnsaetning` | 7,30 % | 20,35 % | 433 | 5930 |
| `arbejdstal` | 6,54 % | 17,31 % | 388 | 5930 |
| `lempeligst` | 6,53 % | 17,22 % | 387 | 5930 |

Linjer der er nøjagtig rigtige (`arbejdstal`): 130 af 246 = 52,85 %
...
| Signal | Værdi |
|---|---:|
| Modeltekst uden modstykke i facit | 696 tegn = 11,49 % af modellens tekst |
| Tekst skrevet dér hvor facit siger `[?]` | 116 tegn fordelt på 18 steder |
...
| Mål | Værdi |
|---|---:|
| Facit-linjer der ligger inden for én af modellens linjer | 238 af 246 |
| Facit-linjer der får deres egen modellinje | 245 af 246 |
...
|---|---:|---:|---:|---:|
| `273108_001555` | 13,56 % | 65,24 % | 14/18 | 160 |
| `273104_001639` | 11,13 % | 77,81 % | 19/22 | 75 |
...
| `273100_001306` | 2,97 % | 94,31 % | 23/26 | 46 |
...
|---|---:|---:|---:|---:|
| `273108_001555` | 65,24 % | 13,56 % | 14/18 | 160 |
| `273105_001570` | 73,30 % | 5,95 % | 18/26 | 96 |
| `273104_001639` | 77,81 % | 11,13 % | 19/22 | 75 |
...
| `273100_001306` | 94,31 % | 2,97 % | 23/26 | 46 |
