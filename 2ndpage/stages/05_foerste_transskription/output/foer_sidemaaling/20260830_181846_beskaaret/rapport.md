# Maaling af 20260830_181846_beskaaret

| Bogholderi | |
|---|---|
| Model | `gemini-3.1-pro-preview` |
| Promptversion | `ren_tekst/ren_tekst` |
| Dato | 2026-08-30T18:18:46 |
| Sider målt | 12 |
...
Målt på **91,79 % af facits tegn** (90,36 % af linjerne). De udeladte er de sværeste.

| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 9,44 % | 28,28 % | 634 | 6718 |
| `uden_versaler` | 8,71 % | 25,40 % | 585 | 6718 |
| `uden_diakritika` | 9,42 % | 28,19 % | 633 | 6718 |
| `uden_tegnsaetning` | 8,31 % | 22,56 % | 530 | 6375 |
| `arbejdstal` | 7,51 % | 19,31 % | 479 | 6375 |
| `lempeligst` | 7,50 % | 19,22 % | 478 | 6375 |
...
Den strenge måling ser **76,94 % af facits tegn** (resten ligger på linjer med mindst ét `[?]`) og fik fat i 96,09 % af dem.

| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 9,39 % | 28,33 % | 507 | 5397 |
| `uden_versaler` | 8,69 % | 24,94 % | 469 | 5397 |
| `uden_diakritika` | 9,38 % | 28,22 % | 506 | 5397 |
| `uden_tegnsaetning` | 8,21 % | 22,29 % | 420 | 5117 |
| `arbejdstal` | 7,43 % | 18,89 % | 380 | 5117 |
| `lempeligst` | 7,41 % | 18,78 % | 379 | 5117 |

**Sammenlign de to.** Hovedtallet er 7,51 %, den strenge er 7,43 % (`arbejdstal`) — en forskel på 0,09 %.
...
| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 9,95 % | 28,74 % | 648 | 6511 |
| `uden_versaler` | 9,18 % | 25,91 % | 598 | 6511 |
| `uden_diakritika` | 9,94 % | 28,65 % | 647 | 6511 |
| `uden_tegnsaetning` | 8,73 % | 22,49 % | 537 | 6151 |
| `arbejdstal` | 7,88 % | 19,29 % | 485 | 6151 |
| `lempeligst` | 7,87 % | 19,20 % | 484 | 6151 |

Linjer der er nøjagtig rigtige (`arbejdstal`): 126 af 253 = 49,80 %
...
| Signal | Værdi |
|---|---:|
| Modeltekst uden modstykke i facit | 713 tegn = 11,34 % af modellens tekst |
| Tekst skrevet dér hvor facit siger `[?]` | 141 tegn fordelt på 21 steder |
...
| Mål | Værdi |
|---|---:|
| Facit-linjer der ligger inden for én af modellens linjer | 248 af 253 |
| Facit-linjer der får deres egen modellinje | 253 af 253 |
...
|---|---:|---:|---:|---:|
| `273108_001555` | 16,31 % | 72,04 % | 15/18 | 133 |
| `273103_001462` | 12,54 % | 92,90 % | 25/27 | 69 |
| `273104_001639` | 12,21 % | 95,03 % | 21/22 | 44 |
| `273102_001064` | 9,52 % | 93,05 % | 22/24 | 51 |
| `273105_001570` | 7,59 % | 89,72 % | 24/26 | 90 |
| `273107_001864` | 7,36 % | 81,90 % | 23/29 | 109 |
| `273099_001445` | 7,24 % | 93,73 % | 20/24 | 56 |
| `273109_000081` | 5,86 % | 94,72 % | 20/20 | 35 |
| `273098_001503` | 5,05 % | 91,74 % | 15/17 | 35 |
| `273110_001527` | 3,35 % | 98,16 % | 23/25 | 20 |
...
|---|---:|---:|---:|---:|
| `273108_001555` | 72,04 % | 16,31 % | 15/18 | 133 |
| `273107_001864` | 81,90 % | 7,36 % | 23/29 | 109 |
| `273105_001570` | 89,72 % | 7,59 % | 24/26 | 90 |
| `273098_001503` | 91,74 % | 5,05 % | 15/17 | 35 |
| `273103_001462` | 92,90 % | 12,54 % | 25/27 | 69 |
| `273102_001064` | 93,05 % | 9,52 % | 22/24 | 51 |
| `273099_001445` | 93,73 % | 7,24 % | 20/24 | 56 |
| `273100_001306` | 94,31 % | 2,62 % | 23/26 | 58 |
| `273109_000081` | 94,72 % | 5,86 % | 20/20 | 35 |
| `273104_001639` | 95,03 % | 12,21 % | 21/22 | 44 |
...
| `273098_001503` | `[?]` | faa |
| `273098_001503` | `[?]` | Hoste, |
| `273098_001503` | `[?]. [?]` | Sengen. - Skrigturene |
| `273100_001306` | `[?]` | nu Strøgans |
| `273100_001306` | `[?]` | Hvidske |
| `273100_001306` | `[?]` | st. |
| `273102_001064` | `[?]` | *(intet)* |
| `273102_001064` | `[?]` | kroupøs |
| `273103_001462` | `[?]` | Svulst |
| `273104_001639` | `[?] [?]` | Synes ogsaa |
| `273104_001639` | `[?]` | døset |
| `273104_001639` | `[?]` | tydelig |
| `273105_001570` | `[?] [?] [?]` | p. n. extrem. |
| `273105_001570` | `[?]` | ith |
| … | | *6 steder mere* |
