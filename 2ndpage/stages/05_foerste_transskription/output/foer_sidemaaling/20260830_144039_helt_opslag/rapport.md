# Maaling af 20260830_144039_helt_opslag

| Bogholderi | |
|---|---|
| Model | `gemini-3.1-pro-preview` |
| Promptversion | `textpage-uaendret` |
| Dato | 2026-08-30T14:40:39 |
| Sider målt | 8 |
...
Målt på **92,16 % af facits tegn** (91,21 % af linjerne). De udeladte er de sværeste.

| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 8,68 % | 25,85 % | 379 | 4366 |
| `uden_versaler` | 8,11 % | 23,67 % | 354 | 4366 |
| `uden_diakritika` | 8,47 % | 24,62 % | 370 | 4366 |
| `uden_tegnsaetning` | 7,90 % | 22,42 % | 328 | 4150 |
| `arbejdstal` | 7,30 % | 20,08 % | 303 | 4150 |
| `lempeligst` | 7,08 % | 18,84 % | 294 | 4150 |

Af de 43 linjer med mindst ét `[?]` kunne forankringen redde **40** ind i målingen ved at måle de kendte stumper omkring det ulæselige sted. Grundreglen er ellers, at hele linjen går ud (beslutning 38), så uden det trin ville dækningen have været væsentligt lavere.
...
Den strenge måling ser **73,24 % af facits tegn** (resten ligger på linjer med mindst ét `[?]`) og fik fat i 97,31 % af dem.

| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 8,24 % | 25,04 % | 278 | 3372 |
| `uden_versaler` | 7,74 % | 22,74 % | 261 | 3372 |
| `uden_diakritika` | 8,04 % | 23,80 % | 271 | 3372 |
| `uden_tegnsaetning` | 7,47 % | 22,06 % | 239 | 3200 |
| `arbejdstal` | 6,94 % | 19,75 % | 222 | 3200 |
| `lempeligst` | 6,72 % | 18,51 % | 215 | 3200 |

**Sammenlign de to.** Hovedtallet er 7,30 %, den strenge er 6,94 % (`arbejdstal`) — en forskel på 0,36 %.
...
| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 9,14 % | 26,51 % | 387 | 4232 |
| `uden_versaler` | 8,55 % | 24,36 % | 362 | 4232 |
| `uden_diakritika` | 8,93 % | 25,30 % | 378 | 4232 |
| `uden_tegnsaetning` | 8,19 % | 22,06 % | 328 | 4004 |
| `arbejdstal` | 7,57 % | 19,76 % | 303 | 4004 |
| `lempeligst` | 7,34 % | 18,54 % | 294 | 4004 |

Linjer der er nøjagtig rigtige (`arbejdstal`): 85 af 166 = 51,20 %
...
| Signal | Værdi |
|---|---:|
| Modeltekst uden modstykke i facit | 438 tegn = 10,88 % af modellens tekst |
...
| Mål | Værdi |
|---|---:|
| Facit-linjer der ligger inden for én af modellens linjer | 160 af 166 |
| Facit-linjer der får deres egen modellinje | 166 af 166 |
...
|---|---:|---:|---:|---:|
| `273108_001555` | 16,54 % | 89,17 % | 18/18 | 64 |
| `273104_001639` | 12,83 % | 95,03 % | 21/22 | 41 |
| `273105_001570` | 8,78 % | 80,10 % | 21/26 | 131 |
| `273103_001462` | 7,87 % | 96,63 % | 26/27 | 44 |
| `273099_001445` | 6,69 % | 93,73 % | 20/24 | 51 |
| `273106_001694` | 2,35 % | 99,48 % | 22/22 | 12 |
| `273100_001306` | 2,10 % | 94,31 % | 23/26 | 51 |
| `273098_001503` | 1,39 % | 87,46 % | 15/17 | 44 |
...
|---|---:|---:|---:|---:|
| `273105_001570` | 80,10 % | 8,78 % | 21/26 | 131 |
| `273098_001503` | 87,46 % | 1,39 % | 15/17 | 44 |
| `273108_001555` | 89,17 % | 16,54 % | 18/18 | 64 |
| `273099_001445` | 93,73 % | 6,69 % | 20/24 | 51 |
| `273100_001306` | 94,31 % | 2,10 % | 23/26 | 51 |
| `273104_001639` | 95,03 % | 12,83 % | 21/22 | 41 |
| `273103_001462` | 96,63 % | 7,87 % | 26/27 | 44 |
