# Maaling af 20260830_160840_beskaaret

| Bogholderi | |
|---|---|
| Model | `gemini-3.1-pro-preview` |
| Promptversion | `ren_tekst/ren_tekst` |
| Dato | 2026-08-30T16:08:40 |
| Sider målt | 5 |
...
Målt på **93,31 % af facits tegn** (91,38 % af linjerne). De udeladte er de sværeste.

| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 9,19 % | 29,22 % | 242 | 2632 |
| `uden_versaler` | 8,47 % | 25,65 % | 223 | 2632 |
| `uden_diakritika` | 9,19 % | 29,22 % | 242 | 2632 |
| `uden_tegnsaetning` | 8,71 % | 25,48 % | 217 | 2490 |
| `arbejdstal` | 7,95 % | 21,67 % | 198 | 2490 |
| `lempeligst` | 7,95 % | 21,67 % | 198 | 2490 |

Af de 18 linjer med mindst ét `[?]` kunne forankringen redde **17** ind i målingen ved at måle de kendte stumper omkring det ulæselige sted. Grundreglen er ellers, at hele linjen går ud (beslutning 38), så uden det trin ville dækningen have været væsentligt lavere.
...
Den strenge måling ser **84,88 % af facits tegn** (resten ligger på linjer med mindst ét `[?]`) og fik fat i 96,43 % af dem.

| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 8,96 % | 29,17 % | 206 | 2299 |
| `uden_versaler` | 8,22 % | 25,28 % | 189 | 2299 |
| `uden_diakritika` | 8,96 % | 29,17 % | 206 | 2299 |
| `uden_tegnsaetning` | 8,44 % | 25,56 % | 183 | 2168 |
| `arbejdstal` | 7,66 % | 21,67 % | 166 | 2168 |
| `lempeligst` | 7,66 % | 21,67 % | 166 | 2168 |

**Sammenlign de to.** Hovedtallet er 7,95 %, den strenge er 7,66 % (`arbejdstal`) — en forskel på 0,29 %.
...
| Variant | Tegnfejl (CER) | Ordfejl (WER) | Tegnafstand | Facit-tegn |
|---|---:|---:|---:|---:|
| `raa` | 9,59 % | 29,04 % | 244 | 2543 |
| `uden_versaler` | 8,85 % | 25,53 % | 225 | 2543 |
| `uden_diakritika` | 9,59 % | 29,04 % | 244 | 2543 |
| `uden_tegnsaetning` | 9,06 % | 25,12 % | 217 | 2395 |
| `arbejdstal` | 8,27 % | 21,36 % | 198 | 2395 |
| `lempeligst` | 8,27 % | 21,36 % | 198 | 2395 |

Linjer der er nøjagtig rigtige (`arbejdstal`): 52 af 106 = 49,06 %
...
| Signal | Værdi |
|---|---:|
| Modeltekst uden modstykke i facit | 255 tegn = 10,58 % af modellens tekst |
| Tekst skrevet dér hvor facit siger `[?]` | 27 tegn fordelt på 4 steder |
...
| Mål | Værdi |
|---|---:|
| Facit-linjer der ligger inden for én af modellens linjer | 105 af 106 |
| Facit-linjer der får deres egen modellinje | 106 af 106 |
...
| `273110_001527` | 3,16 % | 98,16 % | 23/25 | 25 |
...
| `273110_001527` | 98,16 % | 3,16 % | 23/25 | 25 |
