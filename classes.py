...
class Journal(BaseModel):
    ...
    addressStreet: str      = Field(description="The (historical) street of the address in Copenhagen. Can also be historical addresses, meaning they may no longer exist in Copenhagen. Typically found in the center of the page.")
    ...
    releaseDate: datetime   = Field(description="Written after 'Udskr', beneath admissionDate. May feature additional text indicating time of day, otherwise assume hour 0. If year isn't written, year is assumed as 1896.")
